...
# create 3rd plot (line graph of sub meters)
...
power_feb3 <- filter(powerdata, Date == "2007-02-01" | Date == "2007-02-02")
# 2880 obs of 11 variables


# time to plot 

with(power_feb3, plot(date_time, Sub_metering_1, 
                      col = "black", 
                      xlab = "", 
...
with(power_feb3, lines(date_time, Sub_metering_1, type = "l", col = "black"))

# add Sub metering 2

with(power_feb3, lines(date_time, Sub_metering_2, type = "l", col = "red"))

# add Sub metering 3

with(power_feb3, lines(date_time, Sub_metering_3, type = "l", col = "blue"))
...
dev.copy(png, file = "plot3.png", width = 480, height = 480) # this opens the connection
